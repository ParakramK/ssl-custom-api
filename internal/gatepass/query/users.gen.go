...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.KataNo = field.NewInt(tableName, "kata_no")
	_user.CompId = field.NewInt(tableName, "comp_id")
...
func (u *user) updateTableName(table string) *user {
	...
	u.KataNo = field.NewInt(table, "kata_no")
	u.CompId = field.NewInt(table, "comp_id")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["kata_no"] = u.KataNo
	u.fieldMap["comp_id"] = u.CompId
}
